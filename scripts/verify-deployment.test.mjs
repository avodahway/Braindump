...
describe('deployment verifier', () => {
  ...
  it('checks public metadata and search index files', async () => {
    const fetchImpl = vi.fn(async (url) => {
      ...
      if (String(url).endsWith('/sitemap.xml')) return xmlResponse('<urlset><url><loc>https://braindump.app/</loc></url><url><loc>https://braindump.app/roadmap</loc></url><url><loc>https://braindump.app/press</loc></url><url><loc>https://braindump.app/examples</loc></url><url><loc>https://braindump.app/pricing</loc></url><url><loc>https://braindump.app/demo</loc></url></urlset>');
