...
const frontendRoutes = ['/', '/privacy', '/terms', '/support', '/data-deletion', '/feedback', '/beta', '/status', '/faq', '/security', '/trust', '/install', '/roadmap', '/press', '/examples', '/pricing', '/demo', '/oauth-demo-checklist', '/timeline', '/operator', '/app'];
const frontendAssets = [
  ...
  },
  {
    ...
    path: '/sitemap.xml',
    kind: 'xml-markers',
    markers: ['<urlset', '<loc>https://braindump.app/</loc>', '<loc>https://braindump.app/roadmap</loc>', '<loc>https://braindump.app/press</loc>', '<loc>https://braindump.app/examples</loc>', '<loc>https://braindump.app/pricing</loc>', '<loc>https://braindump.app/demo</loc>', '<loc>https://braindump.app/oauth-demo-checklist</loc>', '<loc>https://braindump.app/timeline</loc>', '<loc>https://braindump.app/trust</loc>']
  }
];
