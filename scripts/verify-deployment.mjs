...
const frontendRoutes = ['/', '/privacy', '/terms', '/support', '/data-deletion', '/feedback', '/beta', '/status', '/faq', '/security', '/install', '/roadmap', '/press', '/examples', '/operator', '/app'];
const frontendAssets = [
  ...
  },
  {
    ...
    path: '/sitemap.xml',
    kind: 'xml-markers',
    markers: ['<urlset', '<loc>https://braindump.app/</loc>', '<loc>https://braindump.app/roadmap</loc>', '<loc>https://braindump.app/press</loc>', '<loc>https://braindump.app/examples</loc>']
  }
];
