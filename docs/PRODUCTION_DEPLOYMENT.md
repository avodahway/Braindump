...
Then verify the deployed stack:
...
Open `/operator` on the deployed frontend and confirm readiness, metrics, backup status, and the checklist load with the admin token.
