...
| `[BRAIN_DUMP_FRONTEND_ORIGIN]/oauth-demo-checklist` | OAuth demo checklist | Public checklist for verification recordings |
| `[BRAIN_DUMP_FRONTEND_ORIGIN]/timeline` | Launch timeline | Public beta path and current launch stage |
